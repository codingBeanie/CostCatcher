export const Tutorials = [
  {
        ...
        chapter: [
          ...
          },
          {
            ...
            text: 'You will most likely have to adjust the import settings to match the format of the csv file. This includes the date format, the column separator, and the column mapping. You can do this in the tab <span class="text-button">CSV-SETTINGS</span> in the <span class="text-button">SETTINGS</span> menu.'
          },
          {
